...
export default function App() {
  ...
  root.style.setProperty('--header-background-color', mainTheme.header.background);
  root.style.setProperty('--header-text-color', mainTheme.header.color);

  root.style.setProperty('--button-ok-background-color', mainTheme.button.ok.background);
  root.style.setProperty('--button-ok-text-color', mainTheme.button.ok.color);
  root.style.setProperty('--button-cancel-background-color', mainTheme.button.cancel.background);
  root.style.setProperty('--button-cancel-text-color', mainTheme.button.cancel.color);
  root.style.setProperty('--button-stats-background-color', mainTheme.button.stats.background);
  root.style.setProperty('--button-stats-text-color', mainTheme.button.stats.color);

  root.style.setProperty('--sidebar-background-color', mainTheme.sidebar.background);
  root.style.setProperty('--sidebar-links-background-color', mainTheme.sidebar.links.background);
  root.style.setProperty('--sidebar-links-text-color', mainTheme.sidebar.links.color);
  root.style.setProperty('--sidebar-header-background-color', mainTheme.sidebar.header.background);
  root.style.setProperty('--sidebar-header-text-color', mainTheme.sidebar.header.color);
